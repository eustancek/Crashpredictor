...
SUPABASE_KEY = os.getenv("SUPABASE_KEY", " eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZhd2N1d2NxZnd6dmRvYWxjb2N4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTA4NDY3MjYsImV4cCI6MjA2NjQyMjcyNn0.5NCGUTGpPm7w2Jv0GURMKmGh-EQ7WztNLs9
MD5_nSjc
")  # Replace with your actual key

# Fixed PostgreSQL connection string (use full key as password)
...
class DataProcessor:
    def load_and_clean_data(self):
        try:
            ...
            # Generate mock data if no rows exist
            if df.empty:
