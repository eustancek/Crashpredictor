...
# Fixed PostgreSQL connection string for Transaction Pooler (IPv4)
engine = create_engine(
    f"postgresql://"
    f"postgres.fawcuwcqfwzvdoalcocx:"  # Username from Supabase config
    f"{SUPABASE_KEY}@"  # Full Anon key as password
    f"aws-0-ca-central-1.pooler.supabase.com:6543/postgres?sslmode=require"  # Transaction Pooler
)
